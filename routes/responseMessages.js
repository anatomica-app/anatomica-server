...
module.exports = Object.freeze({
    ...
    EMAIL_REGISTERED_ANOTHER_PROVIDER: 'Bu e-mail baska bir saglayici ile kayit olmus.',
    GOOGLE_AUTH_FAILED: 'Google ile giris yapilirken bir hata olustu.',
    APPLE_ID_NOT_FOUND: 'Belirtilen Apple ID ile kayit olmus bir kullanici bulunamadi.',
    ...
    USER_CANNOT_UPDATED: 'Belirtilen kullanicinin bilgileri guncellenirken bir hata olustu.',
    VERIFICATION_MAIL_SENT: 'Belirtilen e-mail adresine aktivasyon maili gonderildi.',
    USER_ALREADY_ACTIVATED_ACCOUNT: 'Belirtilen kullanici hesabini daha once aktif etmis.',
    PASSWORD_RESET_MAIL_SENT: 'Parolama sifirlama baglantisi belirtilen mail adresine gonderildi.',
    PASSWORD_RESET_TOKEN_CANNOT_CREATED: 'Parola sifirlama istegi olusturulurken bir hata meydana geldi.',
    ...
    USER_NAME_CANNOT_CHANGED_MORE_THAN_ONCE_MONTH: 'Kullanici adi ayda bir kereden fazla degistirilemez.'
});