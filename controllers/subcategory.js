...
exports.getAllSubcategoriesWithLanguage = (req, res) => {
...
exports.getAllSubcategoriesWithGivenCategory = (req, res) => {
  const schema = Joi.object({
...
exports.getAllSubcategoriesWithGivenCategoryAndTopics = (req, res) => {
  const schema = Joi.object({
...
exports.getAllSubcategoriesWithTopics = (req, res) => {
  const schema = Joi.object({
    lang: Joi.number().integer().default(1), // Default language is Turkish --> 1
  });
